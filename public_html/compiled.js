...
},{"@thaerious/nidget":12,"jquery":1}],3:[function(require,module,exports){
"use strict";
const $ = window.$ ? window.$ : require("jquery");
const Nidget = require("@thaerious/nidget").Nidget;
...
},{"./HexLayoutManager":2,"@thaerious/nidget":12,"jquery":1}],4:[function(require,module,exports){
...
class DragDropNidget extends Nidget{
...
module.exports = DragDropNidget;

},{"./DragHandler":7,"./Nidget":11}],7:[function(require,module,exports){
...
/**
 * A DragNidget is able to be dragged onto a DropNidget.  When the drag Nidget
 * drag begins, the dragstart method, if avaialable, is called.
 */
class DragNidget extends Nidget{
...
module.exports = DragNidget;

},{"./DragHandler":7,"./Nidget":11}],9:[function(require,module,exports){
const Nidget = require("./Nidget");
const DragHandler = require("./DragHandler").instance;

/**
 * A DropNidget is the target for DragNidgets.
 * When an element is dragged over this element, the dragover method is triggered.
 * When an element is dropped on this element, the drop event is triggered.
 */
class DropNidget extends Nidget{
    ...
    constructor(element){
        ...
        this.$.on("dragover", (event) =>{
            ...
            if (dragNidget && typeof dragNidget.dragover === "function"){
                dragNidget.dragover(event, dragNidget, this);
            }
            if (typeof this.dragover === "function"){
                 this.dragover(event, dragNidget, this);
            }
        });        
        ...
        this.$.on("drop", (event) =>{
            ...
            if (dragNidget && typeof dragNidget.drop === "function"){
                dragNidget.drop(event, dragNidget, this);
            } 
            if (typeof this.drop === "function"){
                this.drop(event, dragNidget, this);
            }
            DragHandler.clear();
        });
    }
...
module.exports = DropNidget;

},{"./DragHandler":7,"./Nidget":11}],10:[function(require,module,exports){
'use strict';
const $ = window.$ ? window.$ : require("jquery");
const Nidget = require("./Nidget");
...
},{"./Nidget":11,"jquery":4}],11:[function(require,module,exports){
"use strict";
const $ = window.$ ? window.$ : require("jquery");
const AbstractModel = require("./AbstractModel");

/**
 * A Nidget is a 1:1 class-object:dom-object pairing.  Actions on the DOM 
 * object should only be called by the Nidget object.
 */
class Nidget extends AbstractModel{
    ...
    constructor(element){
        ...
        if (element === null || element === undefined){
            throw new Error("Invalid parameter in Nidget constructor: element is null or undefined");
        }
        
        if (element.hasAttribute("data-nidget")){
            throw new Error("Element already associated with nidget");
        }
        
        element.setAttribute("data-nidget", this);        
    }
    ...
    static hasNidget(element){
        return $(element).data("nidget") !== undefined;
    }
    
    static getNidget(element){
        return $(element).data("nidget");
    }
    
    copy(){
        return new Nidget(this.element.innerHTML);
    }
