...
class NidgetElement extends HTMLElement{    
    ...
    async connectedCallback(){
        ...
        if (this.hasAttribute(NidgetElement.srcAttribute)) await this.retrieveSource(this.dataAttributes());
    ...
    async retrieveSource(map = {}){
        ...
        let ele = await FileOperations.loadDOMElement(src, map);
